...
class _SliderSettingsTileState extends State<SliderSettingsTile> {
            ...
            _SimpleHeaderTile(
              ...
              subtitle: widget.subtitle.isNotEmpty
                  ...
                  : (widget.units.isNotEmpty
                      ? _handleSubtitleFormatterCallback(value) + widget.units
                      : _handleSubtitleFormatterCallback(value)),
              leading: widget.leading,
              titleTextStyle: widget.titleTextStyle,
              subtitleTextStyle: widget.subtitleTextStyle,
            ),
  ...
  String _handleSubtitleFormatterCallback(double newValue) {
    return widget.subtitleFormatterCallback != null
        ? widget.subtitleFormatterCallback!.call(newValue)
        : newValue.toStringAsFixed(widget.decimalPrecision);
  }
}
